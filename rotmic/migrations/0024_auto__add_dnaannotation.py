...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rotmic_dnaannotation', (
            ...
            ('parentComponent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='annotations', to=orm['rotmic.DnaComponent'])),
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 20, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 20, 0, 0)'}),
        ...
        'rotmic.dnaannotation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parentComponent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'annotations'", 'to': "orm['rotmic.DnaComponent']"}),
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 0, 0)'}),
