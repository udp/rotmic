...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DnaAnnotation'
        db.create_table(u'rotmic_dnaannotation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registeredBy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dnaannotation_created_by', to=orm['auth.User'])),
            ('registeredAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 17, 0, 0))),
            ('modifiedBy', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dnaannotation_modified_by', null=True, to=orm['auth.User'])),
            ('modifiedAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 17, 0, 0))),
            ...
            ('subComponent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.DnaComponent'], null=True, blank=True)),
            ('preceedes', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rotmic.DnaAnnotation'], null=True, blank=True)),
        ))
        db.send_create_signal('rotmic', ['DnaAnnotation'])


    def backwards(self, orm):
        # Deleting model 'DnaAnnotation'
        db.delete_table(u'rotmic_dnaannotation')
    ...
    models = {
        ...
        'rotmic.component': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 17, 0, 0)'}),
            ...
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 17, 0, 0)'}),
        ...
        'rotmic.dnaannotation': {
            'Meta': {'object_name': 'DnaAnnotation'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 17, 0, 0)'}),
            'modifiedBy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dnaannotation_modified_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'preceedes': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rotmic.DnaAnnotation']", 'null': 'True', 'blank': 'True'}),
            'registeredAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 17, 0, 0)'}),
            'registeredBy': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dnaannotation_created_by'", 'to': u"orm['auth.User']"}),
            'strand': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'subComponent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rotmic.DnaComponent']", 'null': 'True', 'blank': 'True'})
        },
        'rotmic.dnacomponent': {
        ...
        'rotmic.sample': {
            ...
            'preparedAt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 17, 0, 0)'}),
